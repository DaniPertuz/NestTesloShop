...
import { IGender, IProduct, ISizes, ITypes } from '../../../interfaces';
...
const ProductAdminPage: FC<Props> = ({ product }) => {
    ...
    const onChangeSize = (size: ISizes): void => {
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        <FormControl sx={{ mb: 1 }}>
                            ...
                            <RadioGroup
                                ...
                                onChange={({ target }) => setValue('type', target.value as ITypes, { shouldValidate: true })}
                            >
                                {
